...
module.exports = {
    ...
    cases_api_url: `${process.env.SOCIAL_CARE_RECORDS_API_URL}/${process.env.CASES_API_ENDPOINT}`,
    people_api_url: `${process.env.SOCIAL_CARE_RECORDS_API_URL}/${process.env.PEOPLE_API_ENDPOINT}`,
